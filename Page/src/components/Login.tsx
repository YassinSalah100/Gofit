    ...
    <div className="min-h-screen flex flex-col md:flex-row bg-gray-50">
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          {(loginStage === 'email' || loginStage === 'password') && (
            <div className="mt-8">
              <div className="relative">
      ...
      <div className={`hidden md:block md:w-1/2 relative overflow-hidden transition-all duration-1000 ease-in-out ${getBackgroundClass()}`}>
        ...
        <div className="relative h-full flex flex-col justify-center items-center z-10 p-12 text-white">
          ...
          {!showMotivation ? (
            ...
            <div className="w-full max-w-md bg-white/10 p-6 rounded-xl backdrop-blur-sm">
              ...
              <p className="mb-4">
                Welcome back to GOFIT! Your fitness journey continues today. Remember:
              </p>
